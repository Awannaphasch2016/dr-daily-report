...
class PrecomputeService:
    ...
    def store_ticker_data(
        ...
        params = (
            ...
            symbol,
            data_date,
            json.dumps(_convert_numpy_to_primitives(price_history), default=str, allow_nan=False) if price_history else None,
            json.dumps(_convert_numpy_to_primitives(company_info), default=str, allow_nan=False) if company_info else None,
            json.dumps(_convert_numpy_to_primitives(financials), default=str, allow_nan=False) if financials else None,
            history_start_date,
            history_end_date,
            row_count,
            expires_at,
