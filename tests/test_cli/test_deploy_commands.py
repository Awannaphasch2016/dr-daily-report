...
class TestDeployCommands:
    ...
    def test_deploy_lambda(self, mock_run, runner):
    ...
    @patch('subprocess.run')
    def test_deploy_lambda_with_doppler(self, mock_run, runner):
    ...
    @patch('subprocess.run')
    def test_deploy_webhook(self, mock_run, runner):
    ...
    @patch('subprocess.run')
    def test_deploy_webhook_with_doppler(self, mock_run, runner):
    ...
    def test_deploy_webhook_help(self, runner):
