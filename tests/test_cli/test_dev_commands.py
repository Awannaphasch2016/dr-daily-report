...
def test_dev_server(mock_run, runner):
...
@patch('subprocess.run')
def test_dev_server_with_doppler(mock_run, runner):
...
@patch('subprocess.run')
def test_dev_shell(mock_run, runner):
...
@patch('subprocess.run')
def test_dev_run_script(mock_run, runner):
...
@patch('subprocess.run')
def test_dev_install(mock_run, runner):
...
def test_dev_server_help(runner):
...
def test_dev_shell_help(runner):
