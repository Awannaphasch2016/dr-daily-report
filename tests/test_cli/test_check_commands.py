...
def test_check_syntax(mock_rglob, mock_run, runner):
...
def test_check_env_all_set(runner):
...
def test_check_env_missing_vars(runner):
...
@patch('subprocess.run')
def test_check_format(mock_run, runner):
...
@patch('subprocess.run')
def test_check_format_with_line_length(mock_run, runner):
...
@patch('subprocess.run')
def test_check_format_not_installed(mock_run, runner):
...
@patch('subprocess.run')
def test_check_lint(mock_run, runner):
...
@patch('subprocess.run')
def test_check_lint_not_installed(mock_run, runner):
...
def test_check_syntax_help(runner):
...
def test_check_env_help(runner):
...
def test_check_format_help(runner):
